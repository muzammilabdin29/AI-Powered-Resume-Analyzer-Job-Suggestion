...
def resume_improvement_tips(resume_text, extracted_skills):
    ...
    #sns.barplot(x=labels, y=scores, palette="Greens_d")
...
2️⃣ AI extracts **basic info & skills**  
3️⃣ Resume matched with job roles using **BERT embeddings**  
4️⃣ View **ATS score, missing skills**, and **job suggestions with reasons**  
5️⃣ Tips to improve your resume with graphs  
""")
